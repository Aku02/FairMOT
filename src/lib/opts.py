...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--output_dir', type=str, default='inference')
    self.parser.add_argument('--image_dir', type=str, default='none')
    self.parser.add_argument('--video_id', type=str, default='58094_000423')
    self.parser.add_argument('--nosave', action='store_true')
    self.parser.add_argument('--img_size', type=str, default="1088x608")
    self.parser.add_argument('--frame_rate', type=float, default=30.0)
  ...
  def update_dataset_info_and_set_heads(self, opt, dataset):
    ...
    if opt.task == 'mot':
      ...
      opt.nID = dataset.nID
      w, h = opt.img_size.split("x")
      opt.img_size = (int(w), int(h))
